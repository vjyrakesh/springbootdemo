package com.rkasibha.rentabook.aspect;
...
public class MethodExecutionTimeAspect {
    ...
    @Around("@annotation(com.rkasibha.rentabook.annotation.MeasureExecutionTime)")
    ...
    @Around("execution(* com.rkasibha.rentabook.repository.*.*(..))")
